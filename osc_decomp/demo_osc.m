...
disp(size(y))
fs = 1e4;
y_lowpass = lowpass(y,2,fs)


MAX_COMPONENT = 6;
tic
[decomp_phase,decomp_mu,decomp_cov,AIC_osc,osc_param] = osc_decomp(y_lowpass,fs,MAX_COMPONENT);
time2=toc
[tmp,K] = min(AIC_osc);
...
save("/Users/matsukiakari/Documents/doctor/RA_work/result_WT130604_L_lowpassed2.mat", "osc_param", "AIC_osc")